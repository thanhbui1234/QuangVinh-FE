...
export const sheetRowsKey = createQueryKeys<number>('sheet-rows')
export const listDocumentKey = createQueryKeys<string>('list-document')
export const notiBellKey = createQueryKeys<string>('noti-bell')
export const colectionWorkBoardsKey = createQueryKeys<string>('colection-work-boards')
